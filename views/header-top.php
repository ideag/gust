...
<!--[if (gte IE 9)| IEMobile |!(IE)]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <meta name="csrf-param" content="7vf95Qo6ovib_R3EXTwwPL-v">

        <title><?php echo GUST_TITLE; ?> &middot; <?php echo GUST_VERSION; ?></title>
    ...
    <body class="<?php echo ($body_class?$body_class:'manage'); ?>">
